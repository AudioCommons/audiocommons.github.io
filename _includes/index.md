...
<a href="/assets/img/diagram.png" target="blank"><img style="margin:auto;margin-bottom:25px;margin-top:25px;" class="img-responsive" src="/assets/img/diagram.png" alt="The Audio Commons Ecosystem"></a>
...
<table class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
            <td>David Plans</td>
            <td>Business School, University of Surrey</td>
